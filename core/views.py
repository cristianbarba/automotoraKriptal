...
#importamos decorados que nos permitira solicitar login en determiando view
...
#se agrega el patron de diseño login_required para que antes de usar la accion ingrese como usuario
@login_required
